...
const Register = () => {    
    ...
    const handleOnSubmit = (e) => {
        ...
        dispatch(userRegister(new FormData(form.current)))
    }
    ...
    return (
        <div>
            <form className='flex flex-wrap w-full' onSubmit={handleOnSubmit} ref={form}>
                ...
                <div className='w-full mb-4'>
                    <div className='mx-4 flex flex-wrap'>                        
                        <button className="border-b-2 border-blue-500 w-full py-1 px-1 outline-none hover:border-blue-400 bg-gray-100 rounded-t hover:bg-gray-200" type="submit">Registrarse</button>
                    </div>  
                </div>    
            </form>
        </div>
